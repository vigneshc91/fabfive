                        ...
                        <table cellpadding="0" cellspacing="0" border="0"  width="100%">
                            <tr>
                                <td align="center" style="padding:10px 0; background-color:#274e18;">
                                    <h2 style="text-algin: center; color:#fff; font-size:20px;">Forgot Password FabFive</h2>
                                </td>
                            </tr>
                        </table>
                        <!-- header End-->
                        ...
                        <table cellpadding="0" cellspacing="0" border="0"  width="100%">
                            <tr>
                                <td style="padding:10px 15px; background-color:#fff; font-size:14px; ">
                                    ...
                                    <p>Click <a href="{{ $resetToken }}" style="font-weight:bold; color:#7F2714; ">here</a> to rest your password.</p>
                                </td>
                            </tr>
                        </table>
                        <table cellpadding="0" cellspacing="0" border="0"  width="100%">
